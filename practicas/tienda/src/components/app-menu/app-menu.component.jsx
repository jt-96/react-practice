...
function AppMenu(props) {
    ...
    const renderMobileMenu = (
        ...
        >
            <MenuItem onClick={clickCarrito}>
                <IconButton size="large" aria-label={`show ${cantidadCarrito} new items`} color="inherit">
            ...
            <MenuItem onClick={clickNotificaciones}>
                <IconButton
                    size="large"
                    aria-label={`show ${clickNotificaciones} new notifications`}
                    color="inherit"
                >
    ...
    return (
        <Box sx={{ flexGrow: 1 }}>
            <AppBar position="static" style={{ "backgroundColor": "#00FFEE", "color": "black" }}>
                <Toolbar>
                    <IconButton
                        size="large"
                        edge="start"
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        <IconButton size="large" aria-label={`show ${cantidadCarrito} new items`} color="inherit" onClick={clickCarrito}>
                            <Badge badgeContent={cantidadCarrito} color="error">
                                <ShoppingCartIcon />
                            </Badge>
                        </IconButton>
